"""
Template: List Results for a Task
Description: Retrieves all results for a specified task
Prerequisites: Valid API credentials, Team/Project/Experiment/Task IDs
API Endpoint: GET /api/v1/teams/{team_id}/projects/{project_id}/experiments/{experiment_id}/tasks/{task_id}/results
"""
...
print(f"Found {len(response['data'])} result(s)")
print(f"{'=' * 70}\n")
...
for result in response["data"]:
    ...
    result_type = attrs.get("result_type", "Unknown")
